...
var TableCell = (function (_super) {
    ...
    TableCell.prototype.render = function () {
        ...
        if (typeof this.props.children === "string") {
            ...
            content = (React.createElement(renderer_1.Text, null, this.props.children.join('')));
        }
        else {
        ...
        return (React.createElement(renderer_1.View, { style: mergedStyles, wrap: (_d = this.props.wrap) !== null && _d !== void 0 ? _d : true }, content));
    };
    return TableCell;
}(React.PureComponent));
